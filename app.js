...
dialog.matches('solution', [
  function (session, args, next) {
    const solution = _.map(builder.EntityRecognizer.findAllEntities(args.entities || [], ENTITIES.SOLUTION) || [], 'entity');
    const country = (builder.EntityRecognizer.findEntity(args.entities || [], ENTITIES.COUNTRY) || {}).entity;
